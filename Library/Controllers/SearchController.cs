...
namespace Library.Controllers
{
    public class SearchController : Controller
    {
        ...
        public SearchController(LibraryContext libraryContext,IUserService userService, IJwtUtils jwtUtils)
        {
        ...
        [HttpGet]
        public async Task<IActionResult> IndexAdmin(int? page, string searchbook, string? currentFilter, List<Genre> Genre, int[] idG, List<Author> Author, int[] idA, List<Year> Year, int[] idY, List<Publisher> Publisher, int[] idP, string selectSort)
        {
        ...
        [AdminstratorAuthorize]
        [HttpPost]
        public async Task<IActionResult> IndexAdmin(int? page, string searchbook, string? currentFilter, List<Genre> Genre, int[] idG, List<Author> Author, int[] idA, List<Year> Year, int[] idY, List<Publisher> Publisher, int[] idP, string selectOption,string selectSort)
        {
            if (selectSort == null) selectSort = ViewBag.Sort;
            if (selectOption == null) selectOption = ViewBag.Option;
            if (searchbook != null) page = 1;
